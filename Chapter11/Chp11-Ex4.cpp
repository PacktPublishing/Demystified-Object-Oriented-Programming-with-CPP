...
class Course   // over-simplified Course class
{
private:
    string title;
    int number = 0;   // in-class initialization will be overwritten following successful alt. constructor (there's no default ctor) 
public:
